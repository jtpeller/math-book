+++
title = "Equality"
description = "Expressions, equations, and more!"
+++
...
{{< dfn "Inequalities" >}} constrain the values of the two expressions for which they define a relationship. They are depicted in the table above, but are reproduced here for ease of reference:
