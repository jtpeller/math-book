+++
title = "Subtraction"
description = "Subtracting quantities from each other"
+++
...
- [Subtraction](#subtraction)
  ...
  - [Subtraction Operands](#subtraction-operands)
  - [Long Subtraction](#long-subtraction)

## Overview

{{< dfn "Subtraction" >}} is the act of separating numbers.

> Subtraction answers: "What happens when I take away a certain amount of things from another group?"

## Example of Subtraction

For instance, if I have 20 watermelons at a party, and the partygoers eat 12 watermelons, how many will I have left?
...
Inverse operations are critical for simplifications and other work, which will be explored in later sections.
...
{{< dfn "Long Subtraction" >}} is similar to long addition, except instead of a carry, you may require what is called a *borrow*!

{{< dfn "Borrows" >}} work how you probably think they do. Rather than carrying the overflow over to the next column, you instead may take away from the next column (hence, borrow).
...
Also notice that the borrow is marked as negative; this clearly indicates that this is a borrow and not a carry.
