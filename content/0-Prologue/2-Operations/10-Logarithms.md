+++
title = "Logarithms"
description = "How can you determine the original exponent for a given power?"
weight = 10
+++
...
{{< dfn "Logarithms" >}} can "undo" this operation by discovering the exponent to which a base must be raised to obtain some specific value.
