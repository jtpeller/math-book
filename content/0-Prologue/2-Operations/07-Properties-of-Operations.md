...
description = "The special properties of Arithmetic Operations"
+++
...
{{< dfn "Associative Property" >}} - Describes a system where parenthesis can be rearranged, and the result will be the same.
...
{{< dfn "Distributive Property" >}} - Describes a system where a term multiplying terms surrounded by parenthesis is equal to each term in the parenthesis multiplied by that outside term.

- For instance, $a\cdot (b+c) = a\cdot b+a\cdot c$. Note how the $a$ is *distributed* to the inside terms ($b$ and $c$).
- {{< dfn "First, Outer, Inner, Last (FOIL)" >}} - Mnemonic to describe how to distribute when the outside term is itself a binomial.
...
{{< dfn "Identity Property" >}} - Describes situations where a number can be multiplied by 1 and the product is itself, or added to 0 and is itself. These are all equivalent.
