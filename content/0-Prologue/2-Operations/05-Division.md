+++
title = "Division"
description = "Division is repeated subtraction!"
+++
...
- [Division](#division)
  ...
  - [Overview](#overview)
    ...
    - [Division Operands](#division-operands)
  - [Fractions](#fractions)
    - [Types of Fractions](#types-of-fractions)
    - [Writing Fractions](#writing-fractions)
...
{{< dfn "Division" >}} is essentially repeated subtraction.
...
{{< dfn "Fractions" >}} represent two numbers divided by each other. Fractions are ways to represent Rational Numbers. The name "rational" comes from the word "ratio"; to which fractions are closely related.

A {{< dfn "ratio" >}} is simply a means of expressing how many times a given number contains another number. For instance, if you had 15 apples and 3 oranges, you would say there is a ***ratio*** of apples to oranges of 5:1. In other words, for every 1 orange, there are 5 apples!
...
{{< dfn "Decimals" >}} are a means of representing any kind of number. You can represent whole numbers with decimals: $4.0$; rational numbers: $5.25$ and even irrational numbers, like: $\pi=3.14159265...$, which makes decimals incredibly useful to use.
...
A {{< dfn "percentage" >}} is a special way of representing a quantity, where the number is expressed as a fraction of 100. It is denoted with the percent sign: $\%$.
...
A {{< dfn "Percent Change" >}} (aka, $\% \text{ Change}$) is a means of expressing how a value has changed from one value to another.
...
{{< dfn "Long Division" >}} is a method of division where the divisor is placed under a special symbol. The dividend is placed to the left, and the quotient is calculated step by step above. Differences are computed below the divisor. This is a method of doing division by hand.
...
The {{< dfn "remainder" >}} is the number left over from division. Like, $5 / 2 = 2.5$. You could also state that $5 / 2 = 2$ with a remainder of $1$. This remainder can also be used to make a mixed form (number and fraction): $5 / 2 = 2 \frac{1}{2}$
