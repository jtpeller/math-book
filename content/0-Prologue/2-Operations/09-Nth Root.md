+++
title = "N-th Root"
description = "An n-th root is repeated division!"
+++
...
There are two special kinds of roots that are very common to mathematics and even more common in applied mathematics. Those are the {{< dfn "square root" >}} and the {{< dfn "cube root" >}}. The square root is when $n=2$ and the cube root describes a root such that $n=3$.
