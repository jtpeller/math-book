+++
title = "Factoring"
description = "Introduces the concept of factoring, used to simplify or sometimes solve functions."
+++
...
{{< dfn "Factoring" >}} is the act of dividing terms out of an expression to simplify it. Sometimes the end result is not actually simplification, but rather to identify function behaviors.
...
When factoring, you almost always want to factor-out the {{< dfn "Greatest Common Factor (GCF)" >}}, which is the largest possible value that exists among all terms in the expression you are factoring.
...
{{< dfn "Prime Factorization" >}} is a technique where the number is factored into its prime numbers. You simply divide it by a prime number until you can no longer divide.
