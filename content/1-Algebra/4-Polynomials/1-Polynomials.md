+++
title = "Polynomials"
description = "Introduces Polynomials"
+++
...
{{< image src="image/quadratic.png" alt="Figure 2.1.1: Quadratic Function, where $f(x)=x^2$" >}}
...
{{< image src="image/quadratic-roots.png" alt="Figure 2.1.2: Quadratic Function, where $f(x)=(x-5)(x+15)$" >}}
...
{{< image src="image/quadratic-vertex.png" alt="Figure 2.1.3: Quadratic Function, where $f(x)=-2(x-2)^2 + 3$" >}}
...
{{< image src="image/quadratic-rootless.png" alt="Figure 2.1.4: Quadratic Function, where $f(x)=(x-2)^2 + 2$" >}}
